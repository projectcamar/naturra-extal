...
const CUSTOM_ORDER_TRANSLATIONS: Record<LanguageCode, CustomOrderTranslation> = {
  en: {
    meta: {
      ...
      description:
        'Order custom industrial furniture according to your needs. Naturra Extal Bekasi serves made-to-order furniture for cafes, restaurants, offices, and homes.'
    },
    hero: {
      title: 'Custom Order',
      imageAlt: 'Custom Order Naturra Extal - Bekasi Industrial Furniture Workshop',
  ...
  id: {
    meta: {
      title: 'Custom Order - Naturra Extal',
      description:
        'Pesan furniture industrial custom sesuai kebutuhan Anda. Workshop Naturra Extal Bekasi melayani custom order untuk cafe, restoran, kantor, dan rumah.'
    },
    hero: {
      title: 'Custom Order',
      imageAlt: 'Custom Order Naturra Extal - Workshop Furniture Industrial Bekasi',
