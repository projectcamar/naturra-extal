...
const SEO_LINKS = [
    ...
    "Bikin Furniture Besi Custom Jabodetabek Berkualitas - Workshop Mangala",
    ...
    "Koleksi Furniture Industrial Terbaru 2025 dari Mangala Living",
    ...
    "Mangala Living: Your SVLK-Certified Furniture Solution",
    "Furniture Cafe Berkualitas",
    "Mengapa Memilih Mangala Living untuk Furniture Komersial Anda?",
    ...
    "Mangala Living: Indonesia's Leading Furniture Manufacturer & Exporter",
